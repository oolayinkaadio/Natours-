...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    el.className = 'marker'; // Add Marker to the coordinates of the Tours::

    new mapboxgl.Marker({
      element: el,
      anchor: 'bottom'
    }).setLngLat(loc.coordinates).addTo(map); // POPUP(i.e creating Popup on the marker to show the name of the locations)::

    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); //Extend map boundaries to include the location of the Tour under consideration::
...
var updateSettings = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_ref, type) {
    var data, url, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
...
var stripe = Stripe('pk_test_51GuhSWISjF6A7AvFC9H3B56S4n7PRSn6p67ffNfZ8aiFeuE1j10GNHW0H3Lrke7tos0XWF9WjuuJ1XcmUdo2N20T00IV1HNwB5');
